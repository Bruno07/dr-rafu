...
export default function App() {
  ...
  return (
    <div>
      ...
      <button onClick={toggleSidebar} data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
      ...
      <aside id="default-sidebar" className={`fixed top-0 left-0 z-40 w-64 md:w-64 lg:w-96 h-screen transition-transform ${!isSidebarOpen ? 'md:-translate-x-0 -translate-x-full' : ' ' } border-r-2 border-gray-100`} aria-label="Sidebar">
        <div className="h-full pt-20 pb-20 overflow-y-auto bg-white dark:bg-gray-800 flex flex-col items-center justify-between">
            
            <a href="javascript:void(0)" className='text-xl absolute top-4 right-4 md:hidden lg:hidden' onClick={toggleSidebar}>x</a>
